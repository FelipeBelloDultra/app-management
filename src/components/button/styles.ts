...
export const buttonStyles = tv({
  base: "flex items-center shrink-0 justify-center rounded px-3 font-bold transition-all data-[disabled=false]:hover:opacity-70 data-[disabled=false]:cursor-pointer",
  variants: {
    color: {
